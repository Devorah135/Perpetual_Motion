...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setFieldReferencesToViewsAndSnackBar(); // contains all the references
        setupBoard();
    }
    ...
    private void setFieldReferencesToViewsAndSnackBar() {
        mSbContainer = findViewById(android.R.id.content);
        ...
        mSnackbar = Snackbar.make(mSbContainer, "Welcome!", Snackbar.LENGTH_LONG); // initializes snackbar but doesn't show it. Therefore can call mSnackbar.dismiss() whenever want
    }
